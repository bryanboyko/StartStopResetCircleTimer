...
- (void)presentPopupViewController:(UIViewController *)viewControllerToPresent animated:(BOOL)flag completion:(void (^)(void))completion {
    if (self.popupViewController == nil) {
        ...
        // rounded corners
        //viewControllerToPresent.view.layer.cornerRadius = 50.0f;
        ...
        // setup
        if (flag) { // animate
            CGRect initialFrame = CGRectMake(finalFrame.origin.x, 0 - viewControllerToPresent.view.frame.size.height/2, finalFrame.size.width, finalFrame.size.height);
            ...
            [UIView animateWithDuration:ANIMATION_TIME delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                viewControllerToPresent.view.frame = CGRectMake(self.view.center.x - viewControllerToPresent.view.frame.size.width/2, self.view.center.y - viewControllerToPresent .view.frame.size.height/2 - 40, viewControllerToPresent.view.frame.size.width, viewControllerToPresent.view.frame.size.height);
